...
export function SalesChart() {
  ...
  return (
    // DARK MODE: bg-slate-900 and border-slate-800
              ...
              <div className="relative w-full flex items-end justify-center h-full">
                ...
                <div
                  className={`w-full max-w-[44px] rounded-t-lg transition-all duration-500 ease-out ${
                    isPeak
                      ? "bg-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.4)]" // Glowing Emerald for peak
                      : "bg-slate-700 hover:bg-emerald-600/80"                 // Dark slate for others
                  }`}
